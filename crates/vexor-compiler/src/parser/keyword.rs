...
define_keywords! {
    ...
    pk_filter => "filter"; Std: Std::Filter,
    pk_drop_while => "dropWhile"; Std: Std::DropWhile,
    pk_drop => "drop"; Std: Std::Drop,
    pk_take_while => "takeWhile"; Std: Std::TakeWhile,
    pk_take => "take"; Std: Std::Take,
    pk_foldl => "foldl"; Std: Std::Foldl,
    pk_foldr => "foldr"; Std: Std::Foldr,
    pk_zip_with => "zipWith"; Std: Std::ZipWith,
    pk_zip => "zip"; Std: Std::Zip,
    pk_flat_map => "flatMap"; Std: Std::FlatMap,
    pk_enumerate => "enumerate"; Std: Std::Enumerate,
    pk_len => "len"; Std: Std::Len,
    pk_reverse => "reverse"; Std: Std::Reverse,
    pk_find => "find"; Std: Std::Find,
    pk_sort_by => "sortBy"; Std: Std::SortBy,
    pk_sort => "sort"; Std: Std::Sort,
